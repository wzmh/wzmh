...
Library.Sections.__index = Library.Sections
	...
	do
		...
		function Library:Window(Options)
            ...
            Glow.Size = UDim2.new(1, 20, 1, 20) -- Larger than the Outline
            ...
            for i = 1, 3 do
                ...
                Layer.BackgroundColor3 = Library.Accent
                Layer.BackgroundTransparency = 0.5 + (i * 0.15) 
                Layer.BorderSizePixel = 0
                Layer.Size = UDim2.new(1, 20 + (i * 10), 1, 20 + (i * 10)) 
